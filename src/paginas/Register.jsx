...
export const Register = () => {
    ...
    const onSubmit = async(e) => { 
        //e.preventDefault()
        try {
            const url = `${import.meta.env.VITE_BACKEND_URL}erick/register`
        ...
        <>
            <div className="bg-white flex justify-center items-center w-1/2">
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    {Object.keys(mensaje).length>0 && <Mensaje tipo={'active'}>{'Usuario Registrado'}</Mensaje>}
                    ...
                    <div className="mt-3 text-xs flex justify-between items-center">
                        ...
                        <Link to="/" className="py-2 px-5 bg-gray-500 text-slate-300 border rounded-xl hover:scale-110 duration-300 hover:bg-gray-900 ">Ingresar</Link>
                    </div>
            ...
            <div className="w-1/2 h-screen bg-[url('/public/images/registrar.png')] 
